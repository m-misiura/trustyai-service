...
class FourierMMDFitting:
    ...
    def __init__(self, random_seed: int = None, delta_stat: bool = None, n_mode: int = None):
        """
        ...
        """
        self._random_seed = random_seed  # Add underscore
        self._delta_stat = delta_stat    # Add underscore
        self._n_mode = n_mode           # Add underscore
        self._scale: Optional[np.ndarray] = None  # Add underscore
        self._a_ref: Optional[np.ndarray] = None  # Add underscore
        self._mean_mmd: Optional[float] = None    # Add underscore
        self._std_mmd: Optional[float] = None     # Add underscore
